    ...
    return (<section className="px-4 pt-0 pb-6 sm:px-6 lg:px-16 xl:px-32">
      <div className="relative overflow-hidden rounded-2xl md:rounded-3xl">
        ...
        <div className="absolute inset-0 rounded-2xl md:rounded-3xl overflow-hidden">
          <img src="/placeholder.webp" alt="" className="h-full w-full object-cover object-[center_10px]"/>
        ...
        {/* Content */}
        <div className="relative mx-auto max-w-[1400px] px-5 py-14 sm:px-10 md:px-16 lg:px-24 md:py-28">
